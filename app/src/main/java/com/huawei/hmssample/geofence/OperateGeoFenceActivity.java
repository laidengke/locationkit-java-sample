...
public class OperateGeoFenceActivity extends LocationBaseActivity implements View.OnClickListener {
    ...
    public static ArrayList<RequestList> requestList = new ArrayList<RequestList>();
    ...
    public void getData() {
        ...
        for (int i = 0; i < geofences.size(); i++) {
            s += "Unique ID is " + geofences.get(i).getUniqueId() + "\n";
        }
...
class RequestList {
    ...
    public String show() {
        String s = "";
        for (int i = 0; i < geofences.size(); i++) {
            s += "PendingIntent: " + String.valueOf(requestCode) + " UniqueID: " + geofences.get(i).getUniqueId() + "\n";
        }
        return s;
    }
